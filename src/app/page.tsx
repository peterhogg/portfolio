      ...
      <AnimatedSection>
        <section id="about" className="my-12">
          ...
          <p className="text-xl text-center max-w-3xl mx-auto">
                        With 9 years of experience as a Software Developer, I specialize in the MEAN stack, building robust and scalable applications. I have a passion for mentoring and a proven ability to lead teams in fast-paced, Agile environments. My expertise in Docker, Kubernetes, Helm, and Git allows me to streamline deployments and enhance team collaboration. I am a results-oriented leader, dedicated to driving project success through clear communication and a commitment to quality.
          </p>
        </section>
      </AnimatedSection>
      <AnimatedSection>
